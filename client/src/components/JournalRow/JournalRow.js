          ...
          <ListItemText
            ...
            secondary={
              <React.Fragment>
                ...
                <Typography component="span" className={classes.inline} color="textPrimary">
                  {this.state.open && this.props.entry.status === 'Unapproved' ? 'Unapprover: ' + this.props.entry.approver : this.state.open && this.props.entry.status === 'Approved' ? 'Approver: ' + this.props.entry.approver : null }
                </Typography>
                <Typography component="span" className={classes.inline} color="textPrimary">
                  {this.state.open && this.props.entry.status === 'Unapproved' ? 'Unapproved Date: ' + this.props.entry.approved_date.toLocaleDateString('en-US') : this.state.open && this.props.entry.status === 'Approved' ? 'Approver: ' + this.props.entry.approved_date.toLocaleDateString('en-US') : null }
                </Typography>
